...
\begin{figure}[H]
```{r visMuslim,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "100%",message =FALSE, warning = FALSE}
...
```{r visPriest,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "100%", warning = FALSE, message = FALSE}
religion <- read.csv("datasets/cleanedDatasets/religionRedditCleaned.csv")
...
\begin{figure}[H]
```{r fig:debiasedCosinePair2,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", dpi = 300, out.width="85%", warning = FALSE, message = FALSE}
...
```{r,echo=FALSE,eval=TRUE,fig.align = "center",cache=TRUE, fig.show = "hold", out.width = "110%", dpi = 300, warning = FALSE, message = FALSE}
