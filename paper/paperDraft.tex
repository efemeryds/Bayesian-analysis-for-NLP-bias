...
\begin{center}\includegraphics[width=1\linewidth]{paperDraft_files/figure-latex/visMuslim-1} \end{center}





\begin{center}\includegraphics[width=1\linewidth]{paperDraft_files/figure-latex/visPriest-1} \end{center}
