...
\begin{center}\includegraphics[width=1\linewidth]{paperDraft_files/figure-latex/visMuslimd-1} \end{center}





\begin{center}\includegraphics[width=1\linewidth]{paperDraft_files/figure-latex/visPriestd-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth]{paperDraft_files/figure-latex/fig:debiasedCosinePair2b-1} \includegraphics[width=0.85\linewidth]{paperDraft_files/figure-latex/fig:debiasedCosinePair2b-2} \end{center}
...
\begin{center}\includegraphics{paperDraft_files/figure-latex/weatjoint2r-1} \end{center}

\pagebreak

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/weat7glovf-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsWeat7Reddit-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsWeat1Google-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsWeat1Glove-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsWeat1Reddit-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsReligionGoogle-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsReligionGlove-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsReligionReddit-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsRaceGoogle-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsRaceGlove-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsRaceReddit-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsGenderGoogle-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsGenderGlove-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsGenderReddit-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsDebiasedReligionReddit-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsDebiasedRaceReddit-1} \end{center}

\begin{center}\includegraphics[width=1.1\linewidth]{paperDraft_files/figure-latex/resultsDebiasedGenderReddit-1} \end{center}
